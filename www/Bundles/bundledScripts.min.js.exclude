function createCookie(){try{var n=$(".shadedBackground"),t=$("#hfldCookieName").val(),i=$("#hfldCulture").val();Cookies.set(t,i,{expires:6e3});n.toggle()}catch(r){console.log("ERROR: [createCookie] "+r.message)}}function jsModalLogin(){function k(){function v(){var n={userId:o.val(),password:y.val()};return console.log("myData"),console.log(n),JSON.stringify(n)}function p(){$.ajax({type:f,url:s,data:h,contentType:c,dataType:l,processdata:a,success:function(n){b(n)},error:function(n){w(n)}})}function w(r){console.log("Service call failed: "+r.status+" "+r.statusText+" "+r.responseText);f=null;varUrl=null;h=null;c=null;l=null;a=null;n.html("*Error logging in.");n.show();t.show();i.hide()}function b(f){if(Cookies.remove("Login"),Cookies.remove("SessionGuid"),Cookies.remove("FullLoginResponse"),f.d.length===0)n.html("*Error logging in."),n.show(),t.show(),i.hide(),r.show(),u.hide();else{Cookies.set("FullLoginResponse",f.d,{domain:"nahu.org"});Cookies.set("FullLoginResponse",f.d,{domain:"dev.nahu.org"});Cookies.set("FullLoginResponse",f.d,{domain:"theandersongrp.com"});Cookies.set("FullLoginResponse",f.d,{domain:"5thstudios.com"});Cookies.set("FullLoginResponse",f.d,{domain:"nahu.5thstudios.com"});var o=JSON.parse(f.d);console.log("Service being called: "+s);console.log(o);o.IsValidated===!0?($.each(o.CookieStructures,function(n,t){Cookies.remove(t.Name);Cookies.set(t.Name,t.Value,{domain:"nahu.org"});Cookies.set(t.Name,t.Value,{domain:"theandersongrp.com"});Cookies.set(t.Name,t.Value,{domain:"5thstudios.com"});Cookies.set(t.Name,t.Value,{domain:"nahu.5thstudios.com"})}),n.hide(),e.foundation("reveal","close"),t.hide(),i.show(),r.hide(),u.show(),location.reload()):(n.html("*Invalid credentials."),n.show(),t.show(),i.hide(),r.show(),u.hide())}}var f="POST",s="/Services/ImisWebservice2017.asmx/Login",h=v(),c="application/json; charset=utf-8",l="json",a=!0;p()}function d(){var n=Cookies.get("SessionGuid");if(n===undefined)t.show(),i.hide();else{var f="POST",c="/Services/ImisWebservice2017.asmx/IsUserLoggedIn",e=l(),o="application/json; charset=utf-8",s="json",h=!0;a();function l(){var t={userToken:n};return JSON.stringify(t)}function a(){$.ajax({type:f,url:c,data:e,contentType:o,dataType:s,processdata:h,success:function(n){y(n)},error:function(n){v(n)}})}function v(n){console.log("Service call failed: "+n.status+" "+n.statusText+" "+n.responseText);f=null;varUrl=null;e=null;o=null;s=null;h=null;t.show();i.hide();r.show();u.hide()}function y(n){console.log(JSON.parse(n.d));t.hide();i.show();r.hide();u.show()}}}function g(){var n=Cookies.get("SessionGuid");if(n===undefined)console.log("Cookie is empty."),console.log("User is not logged in.");else{var t="POST",e="/Services/ImisWebservice2017.asmx/FetchUserInfo",i=o(),r="application/json; charset=utf-8",u="json",f=!0;s();function o(){var t={userToken:n};return JSON.stringify(t)}function s(){$.ajax({type:t,url:e,data:i,contentType:r,dataType:u,processdata:f,success:function(n){c(n)},error:function(n){h(n)}})}function h(n){console.log("Service call failed: "+n.status+" "+n.statusText+" "+n.responseText);t=null;varUrl=null;i=null;r=null;u=null;f=null}function c(n){console.log(JSON.parse(n.d))}}}function nt(){var n=Cookies.get("SessionGuid");if(n===undefined)console.log("Cookie is empty."),console.log("User is not logged in."),t.show(),i.hide();else{var r="POST",s="/Services/ImisWebservice2017.asmx/DisposeSession",u=h(),f="application/json; charset=utf-8",e="json",o=!0;c();function h(){var t={userToken:n};return JSON.stringify(t)}function c(){$.ajax({type:r,url:s,data:u,contentType:f,dataType:e,processdata:o,success:function(n){a(n)},error:function(n){l(n)}})}function l(n){console.log("Service call failed: "+n.status+" "+n.statusText+" "+n.responseText);r=null;varUrl=null;u=null;f=null;e=null;o=null}function a(n){console.log(JSON.parse(n.d))}}}function tt(){function h(){var n={userId:o.val()};return JSON.stringify(n)}function c(){$.ajax({type:t,url:s,data:i,contentType:r,dataType:u,processdata:e,success:function(n){a(n)},error:function(n){l(n)}})}function l(f){console.log("Service call failed: "+f.status+" "+f.statusText+" "+f.responseText);t=null;varUrl=null;i=null;r=null;u=null;e=null;n.html("*Error resetting password.");n.show()}function a(t){if(t.d.length===0)n.html("*Error resetting password."),n.show();else{var i=JSON.parse(t.d);i===!0?(n.hide(),f.html("*Please check your email for the password reset link."),f.show()):(f.hide(),n.html("*Invalid credentials."),n.show())}}var t="POST",s="/Services/ImisWebservice2017.asmx/RecoverPassword",i=h(),r="application/json; charset=utf-8",u="json",e=!0;c()}function c(){Cookies.remove("Login",{domain:"nahu.org"});Cookies.remove("SessionGuid",{domain:"nahu.org"});Cookies.remove("FullLoginResponse",{domain:"nahu.org"});Cookies.remove("validBMember",{domain:"nahu.org"});Cookies.remove("Login",{domain:"theandersongrp.com"});Cookies.remove("SessionGuid",{domain:"theandersongrp.com"});Cookies.remove("FullLoginResponse",{domain:"theandersongrp.com"});Cookies.remove("validBMember",{domain:"theandersongrp.com"});Cookies.remove("Login",{domain:"5thstudios.com"});Cookies.remove("SessionGuid",{domain:"5thstudios.com"});Cookies.remove("FullLoginResponse",{domain:"5thstudios.com"});Cookies.remove("validBMember",{domain:"5thstudios.com"});Cookies.remove("Login",{domain:"nahu.5thstudios.com"});Cookies.remove("SessionGuid",{domain:"nahu.5thstudios.com"});Cookies.remove("FullLoginResponse",{domain:"nahu.5thstudios.com"});Cookies.remove("validBMember",{domain:"nahu.5thstudios.com"});t.show();i.hide();r.show();u.hide();nt();location.reload(!0)}var t=$("#btnSignIn"),l=$(".btnSignIn"),r=$("#btnSignIn_Mbl"),i=$("#btnSignOut"),u=$("#btnSignOut_Mbl"),a=$("#btnSubmitLogin"),v=$("#btnFetchUserInfo"),it=$("#divLogIn"),o=$("#txbUserName"),y=$("#txbPassword"),n=$(".errorMsg"),f=$(".successMsg"),e=$("#dialogModal"),s=$("#loginControls"),h=$("#passwordResetControls"),p=$("#btnSubmitPasswordReset"),w=$("#btnCancelPasswordReset"),b=$("#btnResetPassword");d();t.on("click",function(){e.foundation("reveal","open")});l.on("click",function(){e.foundation("reveal","open")});r.on("click",function(){e.foundation("reveal","open")});a.click(function(){k()});i.click(function(){c()});u.click(function(){c()});v.click(function(){g()});w.click(function(){s.show();h.hide();n.hide();f.hide()});b.click(function(){s.hide();h.show();n.hide();f.hide()});p.click(function(){tt()})}$(document).ready(function(){try{n();function n(){$("body").addClass($(".hfldRootClass").val())}}catch(t){console.log("ERROR: [jsRootClassSwap] "+t.message)}});
/*!
 * is.js 0.9.0
 * Author: Aras Atasaygin
 */
(function(n,t){typeof define=="function"&&define.amd?define(function(){return n.is=t()}):typeof exports=="object"?module.exports=t():n.is=t()})(this,function(){function s(n){return function(){return!n.apply(null,a.call(arguments))}}function k(n){return function(){for(var i=v(arguments),r=i.length,t=0;t<r;t++)if(!n.call(null,i[t]))return!1;return!0}}function d(n){return function(){for(var i=v(arguments),r=i.length,t=0;t<r;t++)if(n.call(null,i[t]))return!0;return!1}}function r(n,t){var r=t+"",i=+(r.match(/\d+/)||NaN),u=r.match(/^[<>]=?|/)[0];return o[u]?o[u](n,i):n==i||i!==i}function v(t){var i=a.call(t),r=i.length;return r===1&&n.array(i[0])&&(i=i[0]),i}function g(t,i){n[t]=function(r){return n.existy(r)&&i[t].test(r)}}function ut(){var u=n,t,r,i;for(t in u)if(h.call(u,t)&&n["function"](u[t]))for(r=u[t].api||["not","all","any"],i=0;i<r.length;i++)r[i]==="not"&&(n.not[t]=s(n[t])),r[i]==="all"&&(n.all[t]=k(n[t])),r[i]==="any"&&(n.any[t]=d(n[t]))}var n={},o,f,c,y,p;n.VERSION="0.9.0";n.not={};n.all={};n.any={};var i=Object.prototype.toString,a=Array.prototype.slice,h=Object.prototype.hasOwnProperty;o={"<":function(n,t){return n<t},"<=":function(n,t){return n<=t},">":function(n,t){return n>t},">=":function(n,t){return n>=t}};n.arguments=function(n){return i.call(n)==="[object Arguments]"||n!=null&&typeof n=="object"&&"callee"in n};n.array=Array.isArray||function(n){return i.call(n)==="[object Array]"};n.boolean=function(n){return n===!0||n===!1||i.call(n)==="[object Boolean]"};n.char=function(t){return n.string(t)&&t.length===1};n.date=function(n){return i.call(n)==="[object Date]"};n.domNode=function(t){return n.object(t)&&t.nodeType>0};n.error=function(n){return i.call(n)==="[object Error]"};n["function"]=function(n){return i.call(n)==="[object Function]"||typeof n=="function"};n.json=function(n){return i.call(n)==="[object Object]"};n.nan=function(n){return n!==n};n["null"]=function(n){return n===null};n.number=function(t){return n.not.nan(t)&&i.call(t)==="[object Number]"};n.object=function(n){return Object(n)===n};n.regexp=function(n){return i.call(n)==="[object RegExp]"};n.sameType=function(t,r){var u=i.call(t);return u!==i.call(r)?!1:u==="[object Number]"?!n.any.nan(t,r)||n.all.nan(t,r):!0};n.sameType.api=["not"];n.string=function(n){return i.call(n)==="[object String]"};n.undefined=function(n){return n===void 0};n.windowObject=function(n){return n!=null&&typeof n=="object"&&"setInterval"in n};n.empty=function(t){if(n.object(t)){var i=Object.getOwnPropertyNames(t).length;return i===0||i===1&&n.array(t)||i===2&&n.arguments(t)?!0:!1}return t===""};n.existy=function(n){return n!=null};n.falsy=function(n){return!n};n.truthy=s(n.falsy);n.above=function(t,i){return n.all.number(t,i)&&t>i};n.above.api=["not"];n.decimal=function(t){return n.number(t)&&t%1!=0};n.equal=function(t,i){return n.all.number(t,i)?t===i&&1/t==1/i:n.all.string(t,i)||n.all.regexp(t,i)?""+t==""+i:n.all.boolean(t,i)?t===i:!1};n.equal.api=["not"];n.even=function(t){return n.number(t)&&t%2==0};n.finite=isFinite||function(t){return n.not.infinite(t)&&n.not.nan(t)};n.infinite=function(n){return n===Infinity||n===-Infinity};n.integer=function(t){return n.number(t)&&t%1==0};n.negative=function(t){return n.number(t)&&t<0};n.odd=function(t){return n.number(t)&&(t%2==1||t%2==-1)};n.positive=function(t){return n.number(t)&&t>0};n.under=function(t,i){return n.all.number(t,i)&&t<i};n.under.api=["not"];n.within=function(t,i,r){return n.all.number(t,i,r)&&t>i&&t<r};n.within.api=["not"];f={affirmative:/^(?:1|t(?:rue)?|y(?:es)?|ok(?:ay)?)$/,alphaNumeric:/^[A-Za-z0-9]+$/,caPostalCode:/^(?!.*[DFIOQU])[A-VXY][0-9][A-Z]\s?[0-9][A-Z][0-9]$/,creditCard:/^(?:(4[0-9]{12}(?:[0-9]{3})?)|(5[1-5][0-9]{14})|(6(?:011|5[0-9]{2})[0-9]{12})|(3[47][0-9]{13})|(3(?:0[0-5]|[68][0-9])[0-9]{11})|((?:2131|1800|35[0-9]{3})[0-9]{11}))$/,dateString:/^(1[0-2]|0?[1-9])([\/-])(3[01]|[12][0-9]|0?[1-9])(?:\2)(?:[0-9]{2})?[0-9]{2}$/,email:/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i,eppPhone:/^\+[0-9]{1,3}\.[0-9]{4,14}(?:x.+)?$/,hexadecimal:/^(?:0x)?[0-9a-fA-F]+$/,hexColor:/^#?([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/,ipv4:/^(?:(?:\d|[1-9]\d|1\d{2}|2[0-4]\d|25[0-5])\.){3}(?:\d|[1-9]\d|1\d{2}|2[0-4]\d|25[0-5])$/,ipv6:/^((?=.*::)(?!.*::.+::)(::)?([\dA-F]{1,4}:(:|\b)|){5}|([\dA-F]{1,4}:){6})((([\dA-F]{1,4}((?!\3)::|:\b|$))|(?!\2\3)){2}|(((2[0-4]|1\d|[1-9])?\d|25[0-5])\.?\b){4})$/i,nanpPhone:/^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$/,socialSecurityNumber:/^(?!000|666)[0-8][0-9]{2}-?(?!00)[0-9]{2}-?(?!0000)[0-9]{4}$/,timeString:/^(2[0-3]|[01]?[0-9]):([0-5]?[0-9]):([0-5]?[0-9])$/,ukPostCode:/^[A-Z]{1,2}[0-9RCHNQ][0-9A-Z]?\s?[0-9][ABD-HJLNP-UW-Z]{2}$|^[A-Z]{2}-?[0-9]{4}$/,url:/^(?:(?:https?|ftp):\/\/)?(?:(?!(?:10|127)(?:\.\d{1,3}){3})(?!(?:169\.254|192\.168)(?:\.\d{1,3}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{1,3}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)(?:\.(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)*(?:\.(?:[a-z\u00a1-\uffff]{2,})))(?::\d{2,5})?(?:\/\S*)?$/i,usZipCode:/^[0-9]{5}(?:-[0-9]{4})?$/};for(c in f)f.hasOwnProperty(c)&&g(c,f);n.ip=function(t){return n.ipv4(t)||n.ipv6(t)};n.capitalized=function(t){var r,i,u,f;if(n.not.string(t))return!1;for(r=t.split(" "),i=0;i<r.length;i++)if(u=r[i],u.length&&(f=u.charAt(0),f!==f.toUpperCase()))return!1;return!0};n.endWith=function(t,i){if(n.not.string(t))return!1;i+="";var r=t.length-i.length;return r>=0&&t.indexOf(i,r)===r};n.endWith.api=["not"];n.include=function(n,t){return n.indexOf(t)>-1};n.include.api=["not"];n.lowerCase=function(t){return n.string(t)&&t===t.toLowerCase()};n.palindrome=function(t){var r,i,u;if(n.not.string(t))return!1;for(t=t.replace(/[^a-zA-Z0-9]+/g,"").toLowerCase(),r=t.length-1,i=0,u=Math.floor(r/2);i<=u;i++)if(t.charAt(i)!==t.charAt(r-i))return!1;return!0};n.space=function(t){if(n.not.char(t))return!1;var i=t.charCodeAt(0);return i>8&&i<14||i===32};n.startWith=function(t,i){return n.string(t)&&t.indexOf(i)===0};n.startWith.api=["not"];n.upperCase=function(t){return n.string(t)&&t===t.toUpperCase()};y=["sunday","monday","tuesday","wednesday","thursday","friday","saturday"];p=["january","february","march","april","may","june","july","august","september","october","november","december"];n.day=function(t,i){return n.date(t)&&i.toLowerCase()===y[t.getDay()]};n.day.api=["not"];n.dayLightSavingTime=function(n){var t=new Date(n.getFullYear(),0,1),i=new Date(n.getFullYear(),6,1),r=Math.max(t.getTimezoneOffset(),i.getTimezoneOffset());return n.getTimezoneOffset()<r};n.future=function(t){var i=new Date;return n.date(t)&&t.getTime()>i.getTime()};n.inDateRange=function(t,i,r){if(n.not.date(t)||n.not.date(i)||n.not.date(r))return!1;var u=t.getTime();return u>i.getTime()&&u<r.getTime()};n.inDateRange.api=["not"];n.inLastMonth=function(t){return n.inDateRange(t,new Date((new Date).setMonth((new Date).getMonth()-1)),new Date)};n.inLastWeek=function(t){return n.inDateRange(t,new Date((new Date).setDate((new Date).getDate()-7)),new Date)};n.inLastYear=function(t){return n.inDateRange(t,new Date((new Date).setFullYear((new Date).getFullYear()-1)),new Date)};n.inNextMonth=function(t){return n.inDateRange(t,new Date,new Date((new Date).setMonth((new Date).getMonth()+1)))};n.inNextWeek=function(t){return n.inDateRange(t,new Date,new Date((new Date).setDate((new Date).getDate()+7)))};n.inNextYear=function(t){return n.inDateRange(t,new Date,new Date((new Date).setFullYear((new Date).getFullYear()+1)))};n.leapYear=function(t){return n.number(t)&&(t%4==0&&t%100!=0||t%400==0)};n.month=function(t,i){return n.date(t)&&i.toLowerCase()===p[t.getMonth()]};n.month.api=["not"];n.past=function(t){var i=new Date;return n.date(t)&&t.getTime()<i.getTime()};n.quarterOfYear=function(t,i){return n.date(t)&&n.number(i)&&i===Math.floor((t.getMonth()+3)/3)};n.quarterOfYear.api=["not"];n.today=function(t){var i=new Date,r=i.toDateString();return n.date(t)&&t.toDateString()===r};n.tomorrow=function(t){var i=new Date,r=new Date(i.setDate(i.getDate()+1)).toDateString();return n.date(t)&&t.toDateString()===r};n.weekend=function(t){return n.date(t)&&(t.getDay()===6||t.getDay()===0)};n.weekday=s(n.weekend);n.year=function(t,i){return n.date(t)&&n.number(i)&&i===t.getFullYear()};n.year.api=["not"];n.yesterday=function(t){var i=new Date,r=new Date(i.setDate(i.getDate()-1)).toDateString();return n.date(t)&&t.toDateString()===r};var nt=n.windowObject(typeof global=="object"&&global)&&global,e=n.windowObject(typeof self=="object"&&self)&&self,tt=n.windowObject(typeof this=="object"&&this)&&this,w=nt||e||tt||Function("return this")(),b=e&&e.document,it=w.is,u=e&&e.navigator,l=(u&&u.appVersion||"").toLowerCase(),t=(u&&u.userAgent||"").toLowerCase(),rt=(u&&u.vendor||"").toLowerCase();return n.android=function(){return/android/.test(t)},n.android.api=["not"],n.androidPhone=function(){return/android/.test(t)&&/mobile/.test(t)},n.androidPhone.api=["not"],n.androidTablet=function(){return/android/.test(t)&&!/mobile/.test(t)},n.androidTablet.api=["not"],n.blackberry=function(){return/blackberry/.test(t)||/bb10/.test(t)},n.blackberry.api=["not"],n.chrome=function(i){var u=/google inc/.test(rt)?t.match(/(?:chrome|crios)\/(\d+)/):null;return u!==null&&n.not.opera()&&r(u[1],i)},n.chrome.api=["not"],n.desktop=function(){return n.not.mobile()&&n.not.tablet()},n.desktop.api=["not"],n.edge=function(n){var i=t.match(/edge\/(\d+)/);return i!==null&&r(i[1],n)},n.edge.api=["not"],n.firefox=function(n){var i=t.match(/(?:firefox|fxios)\/(\d+)/);return i!==null&&r(i[1],n)},n.firefox.api=["not"],n.ie=function(n){var i=t.match(/(?:msie |trident.+?; rv:)(\d+)/);return i!==null&&r(i[1],n)},n.ie.api=["not"],n.ios=function(){return n.iphone()||n.ipad()||n.ipod()},n.ios.api=["not"],n.ipad=function(n){var i=t.match(/ipad.+?os (\d+)/);return i!==null&&r(i[1],n)},n.ipad.api=["not"],n.iphone=function(i){var u=n.ipad()?null:t.match(/iphone(?:.+?os (\d+))?/);return u!==null&&r(u[1]||1,i)},n.iphone.api=["not"],n.ipod=function(n){var i=t.match(/ipod.+?os (\d+)/);return i!==null&&r(i[1],n)},n.ipod.api=["not"],n.linux=function(){return/linux/.test(l)},n.linux.api=["not"],n.mac=function(){return/mac/.test(l)},n.mac.api=["not"],n.mobile=function(){return n.iphone()||n.ipod()||n.androidPhone()||n.blackberry()||n.windowsPhone()},n.mobile.api=["not"],n.offline=s(n.online),n.offline.api=["not"],n.online=function(){return!u||u.onLine===!0},n.online.api=["not"],n.opera=function(n){var i=t.match(/(?:^opera.+?version|opr)\/(\d+)/);return i!==null&&r(i[1],n)},n.opera.api=["not"],n.phantom=function(n){var i=t.match(/phantomjs\/(\d+)/);return i!==null&&r(i[1],n)},n.phantom.api=["not"],n.safari=function(n){var i=t.match(/version\/(\d+).+?safari/);return i!==null&&r(i[1],n)},n.safari.api=["not"],n.tablet=function(){return n.ipad()||n.androidTablet()||n.windowsTablet()},n.tablet.api=["not"],n.touchDevice=function(){return!!b&&("ontouchstart"in e||"DocumentTouch"in e&&b instanceof DocumentTouch)},n.touchDevice.api=["not"],n.windows=function(){return/win/.test(l)},n.windows.api=["not"],n.windowsPhone=function(){return n.windows()&&/phone/.test(t)},n.windowsPhone.api=["not"],n.windowsTablet=function(){return n.windows()&&n.not.windowsPhone()&&/touch/.test(t)},n.windowsTablet.api=["not"],n.propertyCount=function(t,i){var r,u;if(n.not.object(t)||n.not.number(i))return!1;r=0;for(u in t)if(h.call(t,u)&&++r>i)return!1;return r===i},n.propertyCount.api=["not"],n.propertyDefined=function(t,i){return n.object(t)&&n.string(i)&&i in t},n.propertyDefined.api=["not"],n.inArray=function(t,i){if(n.not.array(i))return!1;for(var r=0;r<i.length;r++)if(i[r]===t)return!0;return!1},n.inArray.api=["not"],n.sorted=function(t,i){var u,r;if(n.not.array(t))return!1;for(u=o[i]||o[">="],r=1;r<t.length;r++)if(!u(t[r],t[r-1]))return!1;return!0},ut(),n.setNamespace=function(){return w.is=it,this},n.setRegexp=function(n,t){for(var i in f)h.call(f,i)&&t===i&&(f[i]=n)},n});$(function(){try{n();function n(){is.ie()?$("body").addClass("ie"):is.edge()?$("body").addClass("edge"):is.chrome()?$("body").addClass("chrome"):is.firefox()?$("body").addClass("firefox"):is.opera()?$("body").addClass("opera"):is.safari()&&$("body").addClass("safari")}}catch(t){console.log("ERROR: [jsIsOfType] "+t.message)}});
