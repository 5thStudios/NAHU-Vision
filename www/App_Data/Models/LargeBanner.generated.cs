...
{
	/// <summary>Large Banner</summary>
	[PublishedContentModel("largeBanner")]
	public partial class LargeBanner : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "largeBanner";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public LargeBanner(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<LargeBanner, TValue>> selector)
		{
		...
		///<summary>
		/// Sublinks: *Optional: 0-4 links
		///</summary>
		[ImplementPropertyType("bl_sublinks")]
		public IEnumerable<IPublishedContent> Bl_sublinks
		{
			get { return this.GetPropertyValue<IEnumerable<IPublishedContent>>("bl_sublinks"); }
		}
		...
		///<summary>
		/// Additional Options: Below are additional options.
		///</summary>
		[ImplementPropertyType("lblAdditionalOptions")]
		public string LblAdditionalOptions
		{
			get { return this.GetPropertyValue<string>("lblAdditionalOptions"); }
		}

		///<summary>
		/// Minimal Info: Minimum required information.
		///</summary>
