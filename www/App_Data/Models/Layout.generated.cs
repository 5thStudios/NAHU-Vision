...
{
	// Mixin content Type 2436 with alias "layout"
...
#pragma warning restore 0109
		...
		public static Newtonsoft.Json.Linq.JToken GetBodyText(ILayout that) { return that.GetPropertyValue<Newtonsoft.Json.Linq.JToken>("bodyText"); }
	}
}
