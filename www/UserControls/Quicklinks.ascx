<%@ Control Language="vb" AutoEventWireup="false" CodeFile="Quicklinks.ascx.vb" EnableViewState="false" Inherits="Quicklinks" %>
        ...
        <asp:ListView runat="server" ID="lstvQuickLinks">
            ...
            <ItemTemplate>
                <div class="medium-12 large-12 columns ">
                    <a href='<%# Eval("linkUrl") %>' <%# Common.showInNewTab(Eval("openInNewTab")) %>>
