<%@ Control Language="vb" AutoEventWireup="false" CodeFile="EventPanels.ascx.vb" EnableViewState="false" Inherits="EventPanels" %>
<%@ Register Src="/UserControls/ListItem_TopUpcomingEvent.ascx" TagName="ListItem_TopUpcomingEvent" TagPrefix="uc" %>
